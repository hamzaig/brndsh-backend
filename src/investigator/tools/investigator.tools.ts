...
export const INVESTIGATOR_TOOLS: Anthropic.Tool[] = [
  {
    name: 'fetch_file',
    description:
      'Fetch the complete content of a file from the repo with line numbers prepended. ' +
  ...
  },
  {
    name: 'search_code',
    description:
      'Full-text search across the entire repo. ' +
